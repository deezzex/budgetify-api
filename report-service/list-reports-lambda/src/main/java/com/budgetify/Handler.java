...
public class Handler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            ...
            ReportService reportService = initializer.getReportService();
            ...
            List<ReportResponseDto> responseDtoList;

            if (!isAdmin) {
                int budgetId = RequestValidator.getBudgetIdFromParameters(request);
                authorityService.validateResourceAccess(userId, budgetId, Resource.BUDGET);
                responseDtoList = reportService.getAllReportsByBudgetId(budgetId);
            } else {
                responseDtoList = reportService.getAllReports();
            }
